...
from priml.baselines.srdit.experiments import exp001, exp_smoke


def test_exp001_config_golden() -> None:
    """Keep the complete updated recipe reviewable as text."""
